          ...
          stage('Checkout') {
           ...
           stage('Building image') {
            ...
            stage('Pushing to ECR') {
             steps{  
                  script {
               withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'gsaritha313@gmail.com', accessKeyVariable: 'AKIA552JUDQPVL', secretKeyVariable: 'ZFTB2qU7RmLa6U2JfDLgWtdKPGSUuE0eBaMF7fJZ']]) {
